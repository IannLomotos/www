...
if ( ! class_exists( 'Food_Restro_Zone_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Food_Restro_Zone_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'food_restro_zone_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function food_restro_zone_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Food_Restro_Zone_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'food_restro_zone_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function food_restro_zone_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Food_Restro_Zone_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
