var tm_plugin_array = [
  ...
  },
  {
    name: 'GTranslate',
    slug: 'gtranslate',
    source: 'https://downloads.wordpress.org/plugin/gtranslate.zip',
    required: true,
    file_name: 'gtranslate.php'
  },
  {
    name: 'Currency Switcher for WooCommerce',
    slug: 'currency-switcher-woocommerce',
    source: 'https://downloads.wordpress.org/plugin/currency-switcher-woocommerce.zip',
    required: true,
    file_name: 'currency-switcher-woocommerce.php'
  },
  {
    name: 'WooCommerce',
    slug: 'woocommerce',
