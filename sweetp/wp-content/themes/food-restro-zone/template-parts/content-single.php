...
$food_restro_zone_single_post_page_content =  get_theme_mod( 'food_restro_zone_single_post_page_content', 1 );
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="entry-content">
        <?php if ($food_restro_zone_single_post_page_content == 1 ) {?>
            <?php
            the_content(sprintf(
                wp_kses(
                /* translators: %s: Name of current post. Only visible to screen readers */
                    __('Continue reading<span class="screen-reader-text"> "%s"</span>', 'food-restro-zone'),
                    array(
                        'span' => array(
                            'class' => array(),
                        ),
            ...
            wp_link_pages(array(
                'before' => '<div class="page-links">' . esc_html__('Pages:', 'food-restro-zone'),
                'after' => '</div>',
            ));
