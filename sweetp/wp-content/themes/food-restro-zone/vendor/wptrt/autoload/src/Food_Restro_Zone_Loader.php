...
class Food_Restro_Zone_Loader {
	 ...
	 * @return void
	 */
	public function food_restro_zone_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function food_restro_zone_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function food_restro_zone_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function food_restro_zone_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->food_restro_zone_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function food_restro_zone_load( $class ) {
